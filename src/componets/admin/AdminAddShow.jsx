     ...
     useEffect(()=>{
        ...
        const gettheater = async()=>{
            try {
                ...
                const res = await axios.get("https://movie-ticket-booking-serverside-be.onrender.com/api/v1/theater/get-theater")
                const data = await res.data
     ...
     const onSubmit = async (data) => {
      try {
        const res = await axios.post(
          "https://movie-ticket-booking-serverside-be.onrender.com/api/v1/admin/add-moviebyadmin",
          data,
        );
